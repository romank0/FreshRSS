...
return array(
	...
	'search' => array(
		'advanced_search_help' => 'Ця форма допомагає створювати пошукові запити, але запити вручну ще потужніші.',
		'authors' => 'Автори',
		...
		'date_range' => 'Проміжок дат',
		'date_received' => 'Дата отримання',
		'date_to' => 'До',
		'date_user' => 'Дата зміни користувачем',
		'feeds' => 'Стрічки',
		'free_text' => 'Довільний текст',
		'free_text_help' => 'Шукати і в заголовку, і у вмісті',
		'full_documentation' => 'Перегляньте <a href="https://freshrss.github.io/FreshRSS/en/users/10_filter.html#with-the-search-field" target="_blank">повну документацію з пошуку</a>',
		'labels' => 'Мої мітки',
		'multiple_help' => 'Оберіть один або кілька варіантів (утримуйте <kbd>Ctrl</kbd> або <kbd>Cmd</kbd>)',
		'sources' => 'Джерела',
		'tags' => 'Теги статей',
		'text' => 'Текстовий пошук',
		'text_help' => 'Кілька рядків поєднуються логічним <i>або</i>. Також підтримуються <a href="https://freshrss.github.io/FreshRSS/en/users/10_filter.html#regex" target="_blank">регулярні вирази</a>.',
