...
return array(
	...
	'notification_timeout' => array(
		'bad' => array(
			'label' => 'Показати попереджувальний банер',
			'seconds' => 'секунд (щонайменше 1)',
		),
		'good' => array(
			'label' => 'Показати банер підтвердження',
	...
	'query' => array(
		...
		'create' => 'Створити новий користувацький запит',
		...
		'filter' => array(
			...
			'publish_labels_instead_of_tags' => 'Замінити <i>теги стрічки</i> на <i>користувацькі мітки</i> у спільній RSS-стрічці',
			'search' => 'Вираз',
	...
	'reading' => array(
		...
		'read' => array(
			...
			'when_same_guid_in_category' => 'якщо ідентичний GUID уже є серед <i>n</i> найновіших статей категорії',
